    ...
    private function seedEnglishSteps(): void
    {
        $steps = [
            [
                ...
                'description' => 'Make a sincere intention in your heart to perform Umrah for the sake of Allah. The intention should be made before entering the state of Ihram.',
            ...
            [
                ...
                'description' => 'Enter the sacred state of Ihram by wearing the prescribed clothing and reciting the Talbiyah. This marks the beginning of your sacred journey.',
            ...
            [
                ...
                'description' => 'Enter the Grand Mosque with your right foot, reciting the appropriate supplications. Show respect and reverence for this sacred place.',
            ...
            [
                ...
                'description' => 'Perform seven complete circuits around the Kaaba, starting from the Black Stone. Each circuit should be done with devotion and focus.',
            ...
            [
                ...
                'description' => 'After completing Tawaf, pray two rak\'ah at Maqam Ibrahim if space permits. This is a highly recommended act of worship.',
            ...
            [
                ...
                'locale' => 'en',
                'title' => 'Drink Zamzam',
                'description' => 'Drink from the blessed water of Zamzam while standing and facing the Kaaba. This water has special spiritual significance.',
            ...
            [
                ...
                'description' => 'Walk seven times between the hills of Safa and Marwah, commemorating Hajar\'s search for water. This represents patience and trust in Allah.',
            ...
            [
                ...
                'description' => 'Complete your Umrah by either shaving your head completely (Halq) or trimming your hair (Taqsir). This symbolizes the end of the sacred state.',
            ...
            [
                ...
                'locale' => 'en',
                'title' => 'Leave Ihram',
                'description' => 'After completing all rituals, you may leave the state of Ihram. Normal activities and clothing restrictions are now lifted.',
            ...
            [
                ...
                'description' => 'Throughout your Umrah journey, maintain proper etiquette, make sincere supplications, and remember the spiritual significance of each act.',
    ...
    private function seedDhivehiSteps(): void
    {
        $steps = [
            [
                ...
                'locale' => 'dv',
                'title' => 'ނިއްޔާ (Niyyah)',
                'description' => 'އިންސާނަށް އުމްރަހްގެ ނިއްޔާ ދިމާވުމަށް އިޙްރާމްގަށް ވާހަކަތައްދިނުމުންވަނީ އަޅުގަނޑުމެންނަށް ދިމާވުމަށްޓަކައިންނެވެ.',
            ...
            [
                ...
                'description' => 'އިޙްރާމްގަށް ވާހަކަތައްދިނުމަށްޓަކައިންނެވެ.',
            ...
            [
                ...
                'description' => 'މަސްޖިދުލް ހަރާމުން ވާހަކަތައްދިނުމަށްޓަކައިންނެވެ.',
            ...
            [
                ...
                'locale' => 'dv',
                'title' => 'ތަވާފު (7)',
                'description' => 'ކައުބަގަށް ތަވާފުކުރުމަށްޓަކައިންނެވެ.',
            ...
            [
                ...
                'description' => 'ތަވާފުކުރުމަށްޓަކައިންނެވެ.',
            ...
            [
                ...
                'locale' => 'dv',
                'title' => 'ޒަމޒަމް ޖަމާ',
                'description' => 'ޒަމޒަމް ޖަމާތައްދިނުމަށްޓަކައިންނެވެ.',
            ...
            [
                ...
                'description' => 'ސަފާއަދިމަރމަހްއަށްސަޢީކުރުމަށްޓަކައިންނެވެ.',
            ...
            [
                ...
                'description' => 'އުމްރަހްގަށްޓަކައިންނެވެ.',
            ...
            [
                ...
                'description' => 'އިޙްރާމްގަށްޓަކައިންނެވެ.',
