<div class="card hover:shadow-lg transition-shadow duration-300">
    ...
    <div class="relative mb-4">
        ...
        <div class="absolute top-3 left-3">
            ...
            @elseif($trip->status === 'upcoming')
                <span class="bg-gold-500 text-ink px-3 py-1 rounded-full text-sm font-medium">
                    {{ __('Coming Soon') }}
                </span>
            @else
    ...
    <div class="mb-4">
        <h2 class="text-xl font-bold text-gray-800 mb-2">{{ $trip->title }}</h2>
        
        <div class="space-y-2 text-sm text-gray-600">
            <div class="flex items-center">
                <svg aria-hidden="true" focusable="false" class="w-4 h-4 mr-2 text-wine-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
