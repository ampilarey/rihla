        ...
        <div class="relative mb-8">
            ...
            <div class="absolute top-4 left-4">
                @if($trip->status === 'current')
                    <span class="bg-brand-green text-white px-4 py-2 rounded-full text-sm font-medium">
                        {{ __('Now') }}
                    </span>
                @elseif($trip->status === 'upcoming')
                    <span class="bg-brand-gold text-white px-4 py-2 rounded-full text-sm font-medium">
                        {{ __('Coming Soon') }}
                    </span>
                @else
