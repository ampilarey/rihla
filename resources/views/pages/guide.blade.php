        ...
        <div class="max-w-screen-xl mx-auto px-4 md:px-6 lg:px-8 py-3 md:py-4">
            <div class="flex flex-col sm:flex-row items-center justify-between gap-3 md:gap-4">
                <div class="flex items-center gap-2 text-xs md:text-sm text-gray-600">
                    <svg aria-hidden="true" focusable="false" class="w-4 h-4 md:w-5 md:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 md:gap-8">
                ...
                <div class="lg:hidden mb-6 table-of-contents">
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                        <button @click="mobileTocOpen = !mobileTocOpen" 
                            ...
                            <svg aria-hidden="true" focusable="false" class="w-5 h-5 text-gray-500 transition-transform duration-200" 
         ...
         decoding="async">
                                    ...
                                    <div class="mb-4">
                                        <button @click="toggleDetails({{ $index }})" 
                                            ...
                                            <div class="flex items-center justify-between">
                                                ...
                                                <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-gray-500 transition-transform duration-200" 
                                ...
                                @if($step->hasChecklist())
                                    <div class="mb-4">
                                        <h3 class="text-base font-semibold text-gray-900 flex items-center gap-2 mb-3">
                                            <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-wine-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            @foreach($step->checklist as $item)
                                                <div class="flex items-center gap-2 text-sm text-gray-700">
                                                    <div class="w-4 h-4 border-2 border-wine-500 rounded flex items-center justify-center">
                                                        <svg aria-hidden="true" focusable="false" class="w-3 h-3 text-wine-500 hidden" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                @if($step->hasDua())
                                    <div class="mb-4">
                                        <h3 class="text-base font-semibold text-gray-900 flex items-center gap-2 mb-3">
                                            <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-gold-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                @if($step->hasFiqhNotes())
                                    <div class="mb-4">
                                        <h3 class="text-base font-semibold text-gray-900 flex items-center gap-2 mb-3">
                                            <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-warning" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                @if($step->reference_text)
                                    ...
                                    <div class="mb-4">
                                        <h3 class="text-base font-semibold text-gray-900 flex items-center gap-2 mb-3">
                                            <svg aria-hidden="true" focusable="false" class="w-4 h-4 text-gold-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="fixed bottom-4 md:bottom-6 right-4 md:right-6 z-50 whatsapp-fab">
        <a href="{{ \App\Support\Contact::whatsappUrl(__('I need help with the Umrah guide')) }}" 
           ...
           aria-label="{{ __('I need help with the Umrah guide') }}"
           class="inline-flex items-center justify-center w-12 h-12 md:w-14 md:h-14 bg-success hover:bg-success-dark text-white rounded-full shadow-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-success focus:ring-offset-2">
            <svg aria-hidden="true" focusable="false" class="w-6 h-6 md:w-7 md:h-7" fill="currentColor" viewBox="0 0 24 24">
