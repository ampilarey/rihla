        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
                <div class="card mb-8">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start">
                            <div class="w-12 h-12 bg-brand-green rounded-full flex items-center justify-center mr-4 flex-shrink-0">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <a href="mailto:info@rihlatravels.mv" class="text-brand-green hover:text-brand-green/80 transition-colors">
                ...
                <div class="card">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="{{ $socialSettings['facebook_url'] }}" target="_blank" class="text-blue-600 hover:text-blue-700 transition-colors">
                        ...
                        <a href="{{ $socialSettings['instagram_url'] }}" target="_blank" class="text-purple-600 hover:text-purple-700 transition-colors">
                            <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ $socialSettings['tiktok_url'] }}" target="_blank" class="text-black hover:text-gray-700 transition-colors">
                            <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="text-center">
                <div class="card h-full flex flex-col justify-center">
                    <div class="w-24 h-24 bg-brand-green rounded-full flex items-center justify-center mx-auto mb-6">
                    ...
                    <p class="text-sm text-gray-500 mt-4">
                        {{ __('WhatsApp Number:') }} {{ $socialSettings['whatsapp_number'] ?? '9607972434' }}
                    </p>
                </div>
            </div>
        </div>
