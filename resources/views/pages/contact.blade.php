            ...
            <div>
                ...
                <div class="card">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="{{ $socialSettings['facebook_url'] }}" target="_blank" rel="noopener noreferrer" class="text-wine-500 hover:text-wine-600 transition-colors">
                        ...
                        <a href="{{ $socialSettings['instagram_url'] }}" target="_blank" rel="noopener noreferrer" class="text-purple-600 hover:text-purple-700 transition-colors">
                            <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ $socialSettings['tiktok_url'] }}" target="_blank" rel="noopener noreferrer" class="text-black hover:text-gray-700 transition-colors">
                            <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
