...
@php
    $config = [
        ...
        'call' => [
            ...
            'color' => 'bg-brand-sky-blue hover:bg-blue-600',
            'text' => 'Call Us'
        ],
        'catalog' => [
            'url' => "https://wa.me/c/{$catalog}",
            'icon' => 'M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-5 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z',
            'color' => 'bg-brand-gold hover:bg-amber-600',
            'text' => 'View Catalog'
        ]
    ];
...
<a href="{{ $current['url'] }}" 
   ...
   title="{{ $current['text'] }}">
    ...
    <div class="absolute right-full mr-3 top-1/2 transform -translate-y-1/2 bg-brand-dark-grey text-white px-3 py-2 rounded-lg text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
        {{ $current['text'] }}
        <div class="absolute left-full top-1/2 transform -translate-y-1/2 border-4 border-transparent border-l-brand-dark-grey"></div>
    </div>
</a>
