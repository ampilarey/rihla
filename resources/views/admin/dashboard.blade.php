...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-8">
        ...
        <form method="POST" action="{{ route('logout') }}" class="inline">
            @csrf
            <button type="submit" 
                    class="bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded-lg transition-colors duration-200 flex items-center space-x-2">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div class="card text-center">
            ...
            <p class="text-3xl font-bold text-brand-green">{{ $tripCount }}</p>
        </div>
        ...
        <div class="card text-center">
            ...
            <p class="text-3xl font-bold text-brand-gold">{{ $mediaCount }}</p>
        </div>
        ...
        <div class="card text-center">
            ...
            <p class="text-3xl font-bold text-blue-500">{{ $guideStepCount }}</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="card">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <a href="{{ route('admin.guide-steps.index') }}" 
                   class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-4 px-6 rounded-2xl transition-colors duration-200 text-center flex items-center justify-center space-x-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                    </svg>
                ...
                <a href="{{ route('admin.why-sections.index') }}" 
                   class="bg-purple-600 hover:bg-purple-700 text-white font-medium py-4 px-6 rounded-2xl transition-colors duration-200 text-center flex items-center justify-center space-x-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="card">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-start space-x-3">
                    <div class="w-8 h-8 bg-brand-gold rounded-full flex items-center justify-center flex-shrink-0">
                        <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
