...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-sm border p-6">
            <form method="POST" action="{{ route('admin.hero-banners.store') }}" enctype="multipart/form-data" class="space-y-6" id="hero-banner-form">
                @csrf
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <x-admin.translatable-field name="title" label="Title"
                        :value="old('title', [])" required help="Maximum 120 characters." />

                    <x-admin.translatable-field name="subtitle" label="Subtitle"
                        :value="old('subtitle', [])" type="textarea" :rows="3"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            <x-admin.translatable-field name="primary_cta_text" label="Primary button text"
                                :value="old('primary_cta_text', [])" help="Maximum 60 characters." />
                        </div>
                        ...
                        <div class="md:col-span-2">
                            <x-admin.translatable-field name="secondary_cta_text" label="Secondary button text"
                                :value="old('secondary_cta_text', [])" help="Maximum 60 characters." />
                        </div>
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div class="border-t pt-6 mt-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <select id="heading_size" name="heading_size" class="w-full border border-gray-300 rounded-md px-3 py-2">
                                    ...
                                    <option value="text-2xl" selected>2XL</option>
                            ...
                            <div>
                                ...
                                <select id="heading_weight" name="heading_weight" class="w-full border border-gray-300 rounded-md px-3 py-2">
                                    ...
                                    <option value="font-bold" selected>Bold</option>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <select id="primary_cta_radius" name="primary_cta_radius" class="w-full border border-gray-300 rounded-md px-3 py-2">
                                    ...
                                    <option value="rounded-lg" selected>Large</option>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                            ...
                            <div>
                                <label for="secondary_cta_radius" name="secondary_cta_radius" class="block text-sm font-medium text-gray-700 mb-2">
