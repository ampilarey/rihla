    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="card">
            <form action="{{ route('admin.trips.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <x-admin.translatable-field name="title" :label="__('Trip Title')" :value="old('title', [])" required />

                <x-admin.translatable-field name="location" :label="__('Location')" :value="old('location', [])" />
                ...
                <x-admin.translatable-field name="summary" :label="__('Summary')" :value="old('summary', [])" type="textarea" :rows="3" />

                <x-admin.translatable-field name="details" :label="__('Trip Details')" :value="old('details', [])" type="textarea" :rows="6" />
