            ...
            <div class="card">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        <x-admin.translatable-field name="title" :label="__('Title')"
                            :value="old('title', $medium->getTranslations('title'))" />
                    </div>
                    ...
                    <div class="md:col-span-2">
                        <x-admin.translatable-field name="caption" :label="__('Caption')"
                            :value="old('caption', $medium->getTranslations('caption'))" type="textarea" :rows="3" />
                    </div>
