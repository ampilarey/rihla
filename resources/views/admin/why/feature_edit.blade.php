                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea id="text" name="text" rows="4" 
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('text', $feature->text) }}</textarea>
                        @error('text')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="pt-4 flex space-x-3">
                        ...
                        <a href="{{ route('admin.why-sections.edit', $feature->section) }}" 
                           class="flex-1 bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 text-center">
                            Cancel
                        </a>
                    </div>
                </div>
